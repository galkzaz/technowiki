---
id: software-engineering-infrastructure-devops-databases-relational-mysql-installation
title: Installation
sidebar_position: 1
---
...
we will be able to access it with a command like this:
```bash
...
| `USE polardb_catalog;` | Connect to specific database. |
| `SHOW TABLES;` | List all tables. |
| `DESCRIBE book;` | Show the `book` table schema. |
| `EXIT;` | Quit interactive MySQL console. |
