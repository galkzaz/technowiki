...
image::07-discovery/image.png[alt text]
...
![alt text](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/07-discovery/image-1.png)
...
![The interprocess communication between Alpha App and Beta App is based on the IP address of the specific instance to call](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/07-discovery/Client-side service discovery and load balancing model.png)
