...
image::16-deployment/continuous-delivery/Deployment pipeline - commit stage.png[The first part of the commit stage in a deployment pipeline]
...
![The commit stage goes from code commit to a release candidate](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/continuous-delivery/Deployment-pipeline-from-code-commit-to-acceptance.png)
...
For GitHub Actions refer to [Deployment pipeline(production-stage)](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/continuous-delivery/github-actions/github-actions.adoc#production-stage)
...
![Every time the production stage workflow updates the deployment repository](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/continuous-delivery/Deployment-pipeline-GitOps.png)
