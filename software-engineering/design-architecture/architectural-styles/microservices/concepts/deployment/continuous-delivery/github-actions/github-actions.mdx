...
image::16-deployment/continuous-delivery/github-actions/image.png[The commit stage workflow is executed after you push new changes to the remote repository.]
...
![A personal access token (PAT) granting permissions to trigger workflows in other repositories](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/continuous-delivery/github-actions/personal-access-token-granting-permissions-to-trigger-workflows-in-other-repositories.png)
...
![The commit stage goes from code commit to a release candidate](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/continuous-delivery/github-actions/Deployment-pipeline-from-code-commit-to-ready-for-production-deployment.png)
