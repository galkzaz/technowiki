---
id: design-architecture-architectural-styles-microservices-deployment
title: Microservices
sidebar_position: 16
---
...
For Kubernetes refer to [Configuring CPU and memory](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/kubernetes/Kustomize.adoc#Configuring-CPU-and-memory).
...
For Kubernetes refer to [Configuring Resources For The JVM](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/kubernetes/Kustomize.adoc#Configuring-Resources-For-The-JVM).
