...
image::04-gateway/articles/article02/image.png[alt text]
...
image::04-gateway/articles/article02/image-1.png[alt text]
...
image::04-gateway/articles/article02/image-2.png[alt text]

Internal **orders** endpoint: localhost:8083/api/v1/orders/makeOrder
image::04-gateway/articles/article02/image-3.png[alt text]
