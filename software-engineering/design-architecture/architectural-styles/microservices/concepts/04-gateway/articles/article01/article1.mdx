...
4. Implement a custom <q>Login with Fingerprint</q> flow that is based on OAuth2 refresh tokens.
...
image::04-gateway/articles/article01/image-1.png[alt text]
...
![alt text](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/04-gateway/articles/article01/image-2.png)
...
![Different kinds of Request handling in Spring Cloud Gateway](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/04-gateway/articles/article01/image-3.png)
...
image::04-gateway/articles/article01/image.png[alt text]
