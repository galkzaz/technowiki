...
[idempotency](https://stripe.com/blog/idempotency), you also need to build
...
[rate limiting](https://en.wikipedia.org/wiki/Rate_limiting) strategies
...
a managed service like [ElastiCache](https://aws.amazon.com/elasticache/).
...
want [HTTP 429](https://tools.ietf.org/html/rfc6585#section-4) (Too Many
Requests) or [HTTP 503](https://tools.ietf.org/html/rfc7231#section-6.6.4)
