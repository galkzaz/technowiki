...
image::15-tracing/servers/tempo/Distributed-tracing-architecture-using-the-Grafana-stack.png[Distributed tracing architecture for cloud native applications based on the Grafana stack]
== Running
=== Locally
=== Docker
=== Docker compose
