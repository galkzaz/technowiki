...
![ Producers publish messages to an exchange. Consumers subscribe to queues. Exchanges route messages to queues according to a routing algorithm.](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/10-message-queuing/AMQP-message-routing.png)
...
images::10-message-queuing/Microservices-with-Spring-Boot-and-Spring-Cloud-event-driven-consumer-groups-challenge.png[ Products #1 and #2 consuming the same messages]
...
images::10-message-queuing/Microservices-with-Spring-Boot-and-Spring-Cloud-event-driven-consumer-groups-solution.png[ Consumer group]
...
images::10-message-queuing/Microservices-with-Spring-Boot-and-Spring-Cloud-event-driven-guaranteed-order-and-partitions.png[Specifying keys for messages]
...
* **Microservices with Spring Boot 3 and Spring Cloud**
  ...
  images::10-message-queuing/Microservices-with-Spring-Boot-and-Spring-Cloud-event-driven.png[The createCompositeProduct and deleteCompositeProduct parts of the landscape]
