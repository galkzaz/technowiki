...
Kong offers an open-sourced [Plugin Developer Kit](https://docs.konghq.com/gateway/latest/plugin-development/) (or <q>PDK</q>) in various languages. You can build a Kong plugin with [Go](https://go.dev/), [Javascript](https://www.javascript.com/), [Python](https://www.python.org/), and [Lua](https://www.lua.org/). In Apache APISIX, you can use different [Plugin Runners](https://apisix.apache.org/) to develop plugins using the programming languages you are familiar with. They also embedded [Wasm](https://webassembly.org/) into APISIX, and you can utilize Wasm to compile Wasm bytecode to run in APISIX.
