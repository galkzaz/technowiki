...
image::02-configuration/image-1.png[Each release you deploy is a combination of build and configuration, which is different for each environment]
...
image::02-configuration/image.png[Centralized configuration: overview]
...
![A centralized configuration server manages external properties for many applications across all environments.](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/02-configuration/image-2.png)
