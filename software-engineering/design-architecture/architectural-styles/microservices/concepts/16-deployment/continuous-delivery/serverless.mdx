...
![The Knative command for creating a Service from a container image. Knative will take care of  creating all the resources necessary to deploy the applications on Kubernetes.](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/continuous-delivery/Knative-command-for-creating-a-Service-from-a-container-image.png)
