...
![Virtual machines versus containers](/docs/assets/software-engineering/software-architecture/architecture-styles/microservice/16-deployment/packaging/docker/virtual-machines-versus-containers.png)
...
image::16-deployment/packaging/docker/image.png[The Docker Engine has a client/server architecture, and it interacts with a registry.]
