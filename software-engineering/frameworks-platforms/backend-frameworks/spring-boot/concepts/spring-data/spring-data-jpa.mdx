---
id: frameworks-platforms-backend-frameworks-spring-boot-spring-data-jpa
...
2. The standard configuration file for Spring Data JPA is a Java class that creates and sets
...
3. Spring Data JPA provides support for JPA-based data access layers by reducing the
...
5. Add dependencies
   ...
   ```
6. Configuring the connection to a database using JPA
...
| --- | --- |
| **ANSI SQL Type** | **Java Type** |
| DATE  | * java.sql.Date * java.time.LocalDate * java.util.Date * java.util.Calendar |
| TIME | java.util.Date, java.sql.Time, java.time.OffsetTime , java.time.LocalTime |
...
The `@Version` annotation is used to implement optimistic locking, allowing Spring Data to verify that updates of 
...
image::11-development/02-spring/02-data/spring-data-jpa/Entity-Inhertitance-Mapped-superclass-Cities-API.png[Migrating the entities to a strategy of using a Mapped superclass]
...
+
image::11-development/02-spring/02-data/spring-data-jpa/Entity-Inhertitance-Table-per-Class-Hierarchy-Cities-API.png[New entities with single table relationship]
+
...
image::11-development/02-spring/02-data/spring-data-jpa/Entity-Inhertitance-Table-per-Subclass-Hierarchy-Cities-API.png[]
...
image::11-development/02-spring/02-data/spring-data-jpa/Entity-Inhertitance-Table-per-Class--Cities-API.png[]
...
image::11-development/02-spring/02-data/spring-data-jpa/Entity-Inhertitance-Embeddable-Class-Cities-API.png[Including an embeddable class in the Currency entity]
