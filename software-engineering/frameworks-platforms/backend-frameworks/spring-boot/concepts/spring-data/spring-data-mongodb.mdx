---
id: frameworks-platforms-backend-frameworks-spring-boot-spring-data-mongodb
title: Spring Data MongoDB
sidebar_position: 4
---

Spring Data MongoDB works with mutating objects, so you can’t use Java
...
2. Configuring the connection to a database using JPA
