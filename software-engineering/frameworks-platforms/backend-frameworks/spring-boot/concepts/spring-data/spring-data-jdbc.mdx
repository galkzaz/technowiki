---
id: frameworks-platforms-backend-frameworks-spring-boot-spring-data-jdbc
...
1. Add dependencies
   ...
   ```
2. Configuring the connection to a database using JDBC
...
image::11-development/02-spring/02-data/spring-data-jdbc/mapping between the Java object and the relational table.png[Java classes marked as persistent entities are automatically mapped by Spring Data JDBC to 
