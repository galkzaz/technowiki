---
id: frameworks-platforms-backend-frameworks-spring-boot-spring-webflux
...
!()[/docs/assets/software-engineering/frameworks-platforms/backend-frameworks/spring-boot/spring-webflux/reactive-programmig-blocking-code-log.png]
