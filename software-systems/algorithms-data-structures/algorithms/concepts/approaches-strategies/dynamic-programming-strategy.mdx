...
Sometimes identical computations are performed multiple times when solving a problem. Dynamic programming is identifying repeated subproblems in order to compute them only once. One common way to do this is a method similar to memorizing.
